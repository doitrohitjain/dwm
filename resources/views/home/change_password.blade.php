    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('home.change_password',Crypt::encrypt($userData->id)) }}">
                        @csrf 
                        <!--
						...
						<div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="text" class="form-control @error('name') is-invalid @enderror" name="mobile" value="{{ old('name') }}" maxlength="10" required autocomplete="mobile" autofocus> 
                                @error('mobile')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
